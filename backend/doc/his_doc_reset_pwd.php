                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row mt-3">
                            ...
                            <p class="text-white-50">Back to <a href="index.php" class="text-white ml-1"><b>Log In</b></a> OR <a href="../../home.php" class="text-white ml-1"><b>HomePage</b></a></p>
                            </div> <!-- end col -->
                        </div>
                        <!-- end row -->
