<?php
    ...
    if(isset($_POST['doc_login']))
    {
        ...
        if($rs)
        {
            header("location: his_doc_dashboard.php"); //redirect to the doctor dashboard
        }
        else
        {
...
<head>
    <meta charset="utf-8" />
    <title>Electronic Medical Records - A Super Responsive Information System</title>
                    ...
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center w-75 m-auto">
                                <a href="home.php"> <!-- Changed the link here -->
                                    <span><img src="assets/images/logo-dark.png" alt="" height="22"></span>
                                </a>
                                <p class="text-muted mb-4 mt-3">Enter your nurse number and password to access the Nurse panel.</p>
                            </div>
                            ...
                            <div class="text-center mt-3">
                                <!-- Changed the href link to http://localhost/hospital-php/home.php -->
                                <a href="http://localhost/final/home.php" class="btn btn-primary btn-block">Back to Home</a> <!-- Corrected the path -->
                            </div>
