...
if (isset($_POST['discharge_patient'])) {
    ...
    // SQL to update the discharge status
    $query = "UPDATE his_patients SET pat_discharge_status=? WHERE pat_number=?";
    $stmt = $mysqli->prepare($query);
    $stmt->bind_param('si', $pat_discharge_status, $pat_number);
    $stmt->execute();
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input required="required" type="text" value="<?php echo $row->pat_addr; ?>" name="pat_addr" class="form-control" id="inputCity">
                                                </div>

                                                <div class="form-group col-md-6" style="display:none">
                                                    <label for="inputCity" class="col-form-label">Discharge Status</label>
